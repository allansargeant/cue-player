/*
 * Stoatworks Labs - About window data for SimpleCue.
 *
...
{
    inline constexpr auto name = "SimpleCue";
    inline constexpr auto slug = "simplecue";
    inline constexpr auto hook = "Audio cue player for theatre";
    inline constexpr auto licence = "MIT";
    inline constexpr auto guide = "https://stoatworks-labs.com/software/simplecue/guide/";
    inline constexpr auto page = "https://stoatworks-labs.com/software/simplecue/";
    inline constexpr auto repo = "https://github.com/stoatworks-labs/simplecue";
    inline constexpr auto versionFallback = "v0.3.2";
