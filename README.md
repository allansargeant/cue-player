...
| Build | Download | Size |
| --- | --- | --- |
| Universal (Apple Silicon + Intel) · .dmg disk image | [`simplecue-0.3.1-macos-universal.dmg`](https://github.com/stoatworks-labs/simplecue/releases/download/v0.3.2/simplecue-0.3.2-macos-universal.dmg) | 5.5 MB |
| Universal (Apple Silicon + Intel) · .pkg installer | [`simplecue-0.3.1-macos-universal.pkg`](https://github.com/stoatworks-labs/simplecue/releases/download/v0.3.2/simplecue-0.3.2-macos-universal.pkg) | 4.9 MB |
...
| Build | Download | Size |
| --- | --- | --- |
| x64 · .exe installer | [`simplecue-0.3.1-windows-x64-setup.exe`](https://github.com/stoatworks-labs/simplecue/releases/download/v0.3.2/simplecue-0.3.2-windows-x64-setup.exe) | 2.4 MB |
| ARM64 · .exe installer | [`simplecue-0.3.1-windows-arm64-setup.exe`](https://github.com/stoatworks-labs/simplecue/releases/download/v0.3.2/simplecue-0.3.2-windows-arm64-setup.exe) | 2.2 MB |
